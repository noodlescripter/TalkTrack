                                        ...
                                        <div className="col-sm-6 mb-3 mb-sm-0 mt-2">
                                            <div className="card">
                                                <div className="card-body">
                                                    <h1 className="card-title text-info"> Listening to your
                                                        bullshit </h1>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="d-flex" role="search">
                            ...
                            <div className={"text-light me-2"}>
                                <button className={"btn btn-secondary"} data-bs-toggle="modal"
                                        data-bs-target="#staticBackdropV" onClick={startListening}>
                            ...
                            <button className="btn btn-outline-success" type="submit" data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop" onClick={getRes}>Search
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div className={"mt-4"}>
                {
                    online ? (
                        ...
                        <>
                            <h1>
                                <h3 className={"text-warning"}>Api Key Needed</h3>
                            </h1>
                        </>
                    )
                }
